...
- **Les chargés de cours** : Les professeurs, ainsi que les démonstrateurs représentent également des acteurs de notre domaine car ils sont justement responsables des cours en question. (*Andréa: mais ils participent pas dans le process de choix de cours qui est le domaine...*)

### Dépendances

Dans notre domaine, il existe des dépendances 
