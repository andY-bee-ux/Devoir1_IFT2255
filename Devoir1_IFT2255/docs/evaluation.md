...
### Fonctionnalités : Voir les cours offerts dans un programme, Voir les cours offerts pour un trimestre donné, Voir l'horaire d'un cours pour un trimestre donné
...
### Fonctionnalités : Voir les résultats académiques d'un cours, Comparer deux cours selon les résultats agrégés
