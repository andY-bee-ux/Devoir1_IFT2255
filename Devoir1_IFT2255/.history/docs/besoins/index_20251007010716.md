...
- H4 : Le système ne pourra être utilisé que par les étudiants du DIRO car les informations de Planifium concerne uniquement les cours du DIRO ( pour l'instant). Dans notre prototype interactif, les filtres ont donc été adapté à cet effet.
